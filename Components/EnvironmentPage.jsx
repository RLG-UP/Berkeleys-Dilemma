                ...
                <section className="container my-5">
                    <div className="row justify-content-center">
                        <div className="col-md-12 text-start">
                            ...
                            <p>
                                You agree to indemnify, defend, and hold harmless Berkeley's
                                Dilemma, its affiliates, and their respective officers,
                            ...
                            <address>
                                Berkeley's Dilemma |{" "}
                                <strong>
                                    <i>221 B - Paradise City</i>
                                </strong>{" "}
                                | berkeleysdilemma@gmail.com |{" "}
                                <strong>
                                    <i>01800-4444-9999</i>
                                </strong>
                            </address>
